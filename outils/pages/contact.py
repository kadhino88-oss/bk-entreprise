...
<section class="sec sec--cream">
  <div class="wrap">
    ...
    <div class="steps">
      <div class="step"><div class="step__n">01</div><div class="step__t">Échange</div><div class="step__d">On clarifie votre besoin et ce qui existe déjà de votre côté.</div></div>
      <div class="step"><div class="step__n">02</div><div class="step__t">Proposition</div><div class="step__d">Une direction claire, un périmètre et un délai réalistes.</div></div>
      <div class="step"><div class="step__n">03</div><div class="step__t">Réalisation</div><div class="step__d">On construit, vous validez à chaque étape.</div></div>
    </div>
  </div>
</section>
"""
