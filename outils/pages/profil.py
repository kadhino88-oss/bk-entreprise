...
DESC  = ("Christ Kader Berté, fondateur de BK Entreprise, agence digitale à Genève : concepteur digital et "
         "développeur web. Création de site web, identités visuelles, e-commerce et agents IA.")
  ...
  <div class="wrap">
    <div class="split split--wide">
      ...
      <div class="rv rv--r rv-d1" data-px="0.05">
        <div class="shot shot--3x4 shot--contain"><img src="images/kader-portrait.png" alt="Christ Kader Berté, fondateur de BK Entreprise" loading="lazy"></div>
      </div>
    </div>
  </div>
</section>
    ...
    <div style="max-width:820px;">
      ...
      <div class="flow__step rv rv-d2" style="display:block;padding:clamp(26px,3vw,38px);margin-top:16px;">
        ...
        <p class="lead" style="margin-top:14px;color:var(--tx-inv-muted);">
          ...
          sportifs et des associations. Plus de 1000 créations graphiques et plus de 100 sites
          web réalisés à ce jour, pour des clients un peu partout dans le monde — une sélection
