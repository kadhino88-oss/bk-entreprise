    ...
    <div style="max-width:820px;">
      ...
      <div class="flow__step rv rv-d2" style="display:block;padding:clamp(26px,3vw,38px);margin-top:16px;">
        ...
        <p class="lead" style="margin-top:14px;color:var(--tx-inv-muted);">
          ...
          sportifs et des associations. Une sélection de ces
          <a href="portfolio.html" style="color:var(--gold-strong);font-weight:600;">créations</a>
          est présentée sur ce site, chacune sous son vrai nom.
        </p>
        <p class="lead" style="margin-top:14px;color:var(--tx-inv-muted);">
